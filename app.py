...
@st.cache_data
def load_data():
    file_path = r"C:\Users\Dell\Downloads\classified_groundwater_data_yearwise.csv"
...
file_path = r"C:\Users\Dell\Downloads\merged_dataset1.csv"  # Replace with actual file path
df = pd.read_csv(file_path)
